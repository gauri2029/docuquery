      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-slate-900 leading-tight">DocuQuery</h1>
              <p className="text-xs text-slate-500 hidden sm:block">Ask questions across your technical documentation</p>
            </div>
          </div>

          <div className="flex items-center gap-3">
            <StatusIndicator status={status} detail={detail} />
            <a
              href="https://github.com/gauri2029/docuquery"
              target="_blank"
